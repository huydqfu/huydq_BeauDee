...
class LipsArtistPage extends StatefulWidget {

  @override
  _LipsArtistPageState createState() => _LipsArtistPageState();
}

class _LipsArtistPageState extends State<LipsArtistPage> {
  ...
  void initState() {
    super.initState();
    // getTokenTest();
    UserViewModel().getArtist("Lips").then((data){
      setState(() {
        getData = data;
      });
    }
    ...
    return Scaffold(
      appBar: AppBar(
        ...
        title: Container(
          ...
          child: Text('Lips', textAlign: TextAlign.center, style: TextStyle(fontSize: 20, color: Colors.black),),
        ),
        centerTitle: true,
      ),
